...
class Multiview_Dataset(Dataset):
    ...
    def __init__(self, data_dir, num_views=4, tile_size=(64, 64, 64), shuffle=True, data_augmentation=True):
        ...
        self.data_list = self.load_data()  # List of dictionaries containing paths to views and PSFs
